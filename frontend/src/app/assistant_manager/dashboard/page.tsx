...
import {
  ...
  Trophy, Activity, Award, Star, Play, Settings
} from 'lucide-react';
    ...
    <div>
      ...
      <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">Operational coordination, Kanban scheduling, backlog monitoring and active meeting calendars</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4 mb-8">
        {statCards.map((card, i) => {
          ...
          return (
            <div
              key={card.label}
              className="stat-card glass rounded-xl p-4 transition-all duration-300 hover:scale-[1.02]"
            >

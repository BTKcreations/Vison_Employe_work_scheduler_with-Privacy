...
import {
  ...
  Trophy, Activity, Award, Star, Play, Sparkles
} from 'lucide-react';
    ...
    <div>
      ...
      <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">Strategic oversight, reviewer tools, quality validation and complexity matrix metrics</p>
        </div>
      </div>

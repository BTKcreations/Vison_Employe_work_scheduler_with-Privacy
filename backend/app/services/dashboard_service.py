...
async def get_all_attendance_summary(
    ...
    # Optimization: Use raw PyMongo find with projection to bypass Beanie model instantiation overhead
    ...
    # Build user_id list for scoped attendance query
    ...
    # Optimization: Raw PyMongo find for attendance logs too
    att_projection = {
    ...
    for log in logs:
        uid = str(log["user_id"])
        # Ensure we use IST for date calculation to match dashboard expectations
    ...
    for emp in employees:
        ...
        for i in range(5):
            ...
            if record:
                ...
                entry["is_regularized"] = "Regularized" in remarks

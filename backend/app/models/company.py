...
class Company(Document):
    ...
    geofence_policy: str = Field(
        default="flexible"
    )  # "strict" = block, "flexible" = flag, "disabled" = skip
    # Attendance policy
    min_session_minutes: int = Field(
        default=30
    )  # Minimum session before checkout allowed
    ...
    task_priority_points: dict[str, float] = Field(
        default={
            "critical": 10.0,
            "high": 5.0,
            "medium": 3.0,
    ...
    delay_penalties: dict[str, float] = Field(
        default={
            "on_time": 1.0,
            "1_day_late": 0.75,
            "2_days_late": 0.50,
    ...
    quality_multipliers: dict[str, float] = Field(
        default={"rework": 0.8, "standard": 1.0, "exemplary": 1.2}
    )
    incentive_tiers: list[dict] = Field(
        default=[
            {"min_performance": 0.0, "max_performance": 49.99, "pool_percentage": 0.0},
            {
                "min_performance": 50.0,
                "max_performance": 69.99,
                "pool_percentage": 35.0,
            },
            {
                "min_performance": 70.0,
                "max_performance": 79.99,
                "pool_percentage": 75.0,
            },
            {
                "min_performance": 80.0,
                "max_performance": 109.99,
                "pool_percentage": 100.0,
            },
            {
                "min_performance": 110.0,
                "max_performance": 999.0,
                "pool_percentage": 150.0,
            },
        ]
    )
    attendance_points: dict[str, float] = Field(
        default={
            "present": 1.0,
            "late_under_30": 0.75,
            "late_over_30": 0.5,

...
class Attendance(Document):
    ...
    distance_from_office_in: Optional[float] = (
        None  # Distance from office at check-in (meters)
    )
    distance_from_office_out: Optional[float] = (
        None  # Distance from office at check-out (meters)
    )

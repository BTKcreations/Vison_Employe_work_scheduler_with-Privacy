...
async def calculate_corporate_payroll(
    ...
    if total_working_days > 0:
        ...
        daily_rate = 0.0
        lop_deduction = 0.0
        # If there are 0 working days in the period, they don't earn any of the active prorated gross (which is based on days active).
        # We explicitly cap earned_salary at 0 to avoid giving a full month's gross for 0 total_working_days.
        earned_salary = 0.0
